                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: [
                            DropdownMenuItem(
                              value: 'kelompok_tani',
                              child: Text('Kelompok Tani', style: GoogleFonts.poppins(fontSize: 14, color: const Color(0xFF0F172A))),
                            ),
                            DropdownMenuItem(
                              value: 'brigade_pangan',
                              child: Text('Brigade Pangan', style: GoogleFonts.poppins(fontSize: 14, color: const Color(0xFF0F172A))),
                            ),
                          ],
                          onChanged: (val) {
                            setModalState(() {
