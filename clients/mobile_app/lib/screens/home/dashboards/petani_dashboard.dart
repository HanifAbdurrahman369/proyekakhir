        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildQuickActionCard(
                title: 'Input Panen',
                subtitle: 'Catat produksi pala',
                icon: Icons.add_circle_outline_rounded,
                color: Colors.orange.shade800,
                onTap: () {
                  // Aksi Input Panen
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Membuka Form Input Panen...')),
                  );
                },
              ),
              _buildQuickActionCard(
                title: 'Riwayat Panen',
                subtitle: 'Data produksi tani',
                icon: Icons.history_edu_rounded,
                color: Colors.blue.shade700,
                onTap: () {
                  // Aksi Riwayat Panen
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Membuka Riwayat Panen...')),
                  );
                },
              ),
              _buildQuickActionCard(
                title: 'Notifikasi',
                subtitle: 'Pesan & info dinas',
