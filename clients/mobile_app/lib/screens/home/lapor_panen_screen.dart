    ...
    if (success) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text('Gagal Lapor Panen', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
          content: Text(provider.errorMessage ?? 'Terjadi kesalahan sistem.', style: GoogleFonts.poppins()),
          actions: [
            TextButton(
            ...
            children: [
                      ...
                      if (siapPanen.isEmpty) ...[
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: GoogleFonts.poppins(fontSize: 11, color: const Color(0xFF92400E), fontWeight: FontWeight.w600),
                          ),
                        ),
                      ],
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.poppins(fontSize: 12, color: const Color(0xFF1E40AF), height: 1.4),
                ),
              ),
