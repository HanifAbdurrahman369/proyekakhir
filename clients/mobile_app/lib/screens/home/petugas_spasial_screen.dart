...
class _PetugasSpasialScreenState extends State<PetugasSpasialScreen> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              _buildSummaryPill('Dipetakan', '$sudah', const Color(0xFF3E7D00)),
              const SizedBox(width: 8),
              _buildSummaryPill(
                'Lengkap',
        ...
        lahanPolygons.addAll(
          _parsePolygons(
            ...
            borderColor: isSelected
                ...
                : const Color(0xFF3E7D00),
            fillColor:
                (isSelected ? const Color(0xFF0F766E) : const Color(0xFF3E7D00))
  ...
  Widget _toolButton(
    ...
    final color = danger ? const Color(0xFFDC2626) : const Color(0xFF3E7D00);
  ...
  InputDecoration _inputDecoration(String label) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        borderSide: const BorderSide(color: Color(0xFF3E7D00), width: 1.4),
      ),
