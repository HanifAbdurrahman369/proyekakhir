    ...
    if (success) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text('Gagal Mengajukan Lahan', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
          content: Text(provider.errorMessage ?? 'Terjadi kesalahan sistem, silakan coba lagi.', style: GoogleFonts.poppins()),
          actions: [
            TextButton(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: GoogleFonts.poppins(color: Colors.red[800], fontSize: 13, fontWeight: FontWeight.w500),
                        ),
                      ),
                    ],
                  ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Tambah Lahan Baru',
                        style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF14280B)),
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.bold, color: const Color(0xFF1E40AF)),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      '- Setelah disetujui, Anda wajib menemui petugas lapangan untuk koordinasi pemetaan area sawah Anda secara langsung.',
                      style: GoogleFonts.poppins(fontSize: 12, color: const Color(0xFF1E3A8A), height: 1.4),
                    ),
                    const SizedBox(height: 4),
                    Text(
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: Text(
                        'Batal',
                        style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: const Color(0xFF475569)),
                      ),
                    ),
                  ),
                  const SizedBox(width: 12),
      ...
      child: Column(
        children: [
          CircleAvatar(
            ...
            child: Text(
              number,
              style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.bold, color: isActive ? Colors.white : const Color(0xFF64748B)),
            ),
          ),
          const SizedBox(height: 6),
          Text(
            title,
            style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.bold, color: isActive ? Colors.green[800] : const Color(0xFF334155)),
            textAlign: TextAlign.center,
          ),
        ],
      ),
