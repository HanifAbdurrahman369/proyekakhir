...
<div class="flex flex-col gap-4">
    <div class="flex items-start gap-3">
        <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:rgba(255,255,255,.12)">
            <svg class="w-4 h-4" style="fill:#BBF451" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>
        </div>
        <div>
            <p class="text-sm font-semibold text-white">Akun Aman & Terverifikasi</p>
            <p class="text-xs" style="color:rgba(255,255,255,.55)">Data dilindungi dengan enkripsi</p>
        </div>
    </div>
    <div class="flex items-start gap-3">
        <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:rgba(255,255,255,.12)">
            <svg class="w-4 h-4" style="fill:#BBF451" viewBox="0 0 24 24"><path d="M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"/></svg>
        </div>
        <div>
            <p class="text-sm font-semibold text-white">Akses Penuh Fitur</p>
            <p class="text-xs" style="color:rgba(255,255,255,.55)">Semua modul tersedia setelah verifikasi</p>
        </div>
    </div>
</div>
@endsection
...
<h1 class="text-xl font-bold text-gray-800 mb-1">Buat Akun Baru</h1>
<p class="text-sm text-gray-400 mb-6">Isi data diri Anda dengan lengkap</p>
...
<form action="{{ route('register') }}" method="POST" class="space-y-4">
    ...
    <div class="space-y-1.5">
        ...
        <div class="relative">
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Nama lengkap Anda"
                class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition placeholder-gray-300 @error('name') border-red-400 @enderror"
                required>
        </div>
    </div>
    ...
    <div class="space-y-1.5">
        ...
        <div class="relative">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>
            </span>
...
<p class="text-center text-xs text-gray-400 mt-5">
    Sudah punya akun?
    <a href="{{ route('login') }}" class="text-primary-600 font-semibold hover:text-primary-800">Masuk di sini</a>
</p>
