...
<body>
        ...
        <table>
            <tr>
                ...
                <td class="info-container">
                    <div style="font-weight: bold; font-size: 12px; color: #14280b; margin-bottom: 2px;">Daftar Lahan Sawah Terverifikasi</div>
    ...
    <div class="footer">
        Dokumen ini dibuat otomatis oleh Sistem SiTani - Laporan Eksekutif Lahan Sawah Daerah.
    </div>
