        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-2 md:mt-0">
                <div class="relative w-full sm:w-64">
                    <input type="text" id="search-lahan" placeholder="Cari lahan, kecamatan, kelurahan..." class="w-full bg-slate-50 border border-slate-200 text-slate-700 text-sm rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all">
