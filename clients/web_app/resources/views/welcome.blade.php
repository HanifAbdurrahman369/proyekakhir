    ...
    <div class="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="space-y-8" style="color: white;">
            ...
            <div style="padding-top: 1.5rem; border-top: 1px solid rgba(4, 120, 87, 0.5);">
                ...
                <a href="{{ route('download.app') }}" class="sipetani-btn-download">
...
<div class="w-full py-24 px-6 md:px-12 lg:px-20 bg-slate-50/50 flex flex-col items-center font-['Poppins']">
    ...
    <!-- Header Section -->
    <div class="max-w-4xl w-full relative mb-8 mt-10 px-4 sm:px-0 text-center mx-auto">
        <!-- Decorative Background Layer -->
        <div class="absolute -top-10 -left-10 w-64 h-64 bg-emerald-300/20 rounded-full blur-3xl -z-10 pointer-events-none"></div>
        <div class="absolute top-10 right-0 w-72 h-72 bg-teal-200/20 rounded-full blur-3xl -z-10 pointer-events-none"></div>

        <div class="relative z-10 flex flex-col items-center">
            <!-- Badge -->
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 shadow-sm mb-4">
                <span class="flex h-2 w-2 relative">
                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                </span>
                <p class="text-emerald-700 text-[10px] font-bold tracking-widest uppercase">Pemetaan Geospasial</p>
            </div>
            
            <h2 class="text-slate-900 text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight mb-4">
                Eksplorasi <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">Peta Pertanian</span>
            </h2>
            
            <p class="text-slate-500 text-base sm:text-lg font-medium leading-relaxed max-w-3xl mx-auto">
                Peta interaktif ini memvisualisasikan data geospasial lahan sawah secara <span class="text-slate-700 font-semibold">real-time</span>. Jelajahi sebaran kelompok tani di Kabupaten Barito Kuala dengan mengklik batas kecamatan atau titik koordinat lahan untuk melihat informasi analitik mendetail mengenai hasil panen dan status lahannya.
            </p>
        </div>
    </div>
